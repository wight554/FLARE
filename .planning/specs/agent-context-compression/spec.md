...
## Purpose
Reviewed bulk-compression workflow for AI-facing context files and existing OpenSpec spec bodies, preserving normative clauses/structure and excluding operator/user documentation.
## Requirements
