...
## Purpose
Tool-agnostic caveman-full chat-response default for agents, sourced from `openspec/COMMS.md`, with explicit human-readable exclusions (commits/PRs, code, user docs, security/irreversible prose).
## Requirements
