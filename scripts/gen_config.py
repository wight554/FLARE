...
def main():
    ...
    lines = [
        ...
        f"#define CONF_RELAY_ESTIMATE_LO_SPS {mm_min_to_sps(get('relay_estimate_lo'), l1)}",
        f"#define CONF_RELAY_ESTIMATE_HI_SPS {mm_min_to_sps(get('relay_estimate_hi'), l1)}",
        f"#define CONF_RELAY_CONFIDENCE_CYCLES {get('relay_confidence_cycles')}",
        f"#define CONF_RELAY_CONFIDENCE_WINDOW_MS {get('relay_confidence_window_ms')}",
        f"#define CONF_RELAY_SEED_SPS {mm_min_to_sps(get('relay_seed_rate'), l1)}",
        f"#define CONF_RELAY_SEED_WARMUP_MS {get('relay_seed_warmup_ms')}",
        f"#define CONF_RELAY_MIN_FLIP_MM {get_float('relay_min_flip_mm')}f",
