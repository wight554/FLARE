...
## Purpose
Tool-agnostic semantic compression convention for OpenSpec artifacts — the in-repo `openspec/COMPRESSION.md` ruleset, the cross-UI authoring directive, and the density tripwire that gates uncompressed specs in regression.
## Requirements
