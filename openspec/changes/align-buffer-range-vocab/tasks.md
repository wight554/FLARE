...
- [x] 2.3 Update flash settings-store field mapping; bump `SETTINGS_VERSION`
...
- [x] 4.1 `cmake --build build_local`
- [x] 4.2 `python3 -m py_compile scripts/*.py`
- [x] 4.3 `openspec validate align-buffer-range-vocab --strict`
- [x] 4.4 Type-P parity reasoning: only the half-value *source* changes,
...
- [x] 4.5 Confirm no `buf_half_travel_mm` / `buf_size_mm` /
