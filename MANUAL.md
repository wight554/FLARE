...
| `SYNC_RELAY_TRIM_STEP_SPS` | `sync_relay_trim_step_sps` | Runtime-only type-D residual trim step in raw SPS. COMPRESSION touches subtract this; TENSION touches add it. | 300 |
