...
| `RL:` | Manual| **Reload Load** — manually triggers RELOAD sync. Pushes active lane to approach and follow a disconnected tail. Returns `ER:BUSY:LANE` if toolchange/motion is active. |
