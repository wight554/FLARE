...
int   SYNC_TENSION_BURST_MS = CONF_SYNC_TENSION_BURST_MS;
int   SYNC_TENSION_ESC_STEP_SPS = CONF_SYNC_TENSION_ESC_STEP_SPS;
float SYNC_TENSION_ESC_RATIO = CONF_SYNC_TENSION_ESC_RATIO;
