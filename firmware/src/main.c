...
int   RELAY_ESTIMATE_LO_SPS = CONF_RELAY_ESTIMATE_LO_SPS;
int   RELAY_ESTIMATE_HI_SPS = CONF_RELAY_ESTIMATE_HI_SPS;
int   RELAY_CONFIDENCE_CYCLES = CONF_RELAY_CONFIDENCE_CYCLES;
int   RELAY_CONFIDENCE_WINDOW_MS = CONF_RELAY_CONFIDENCE_WINDOW_MS;
int   RELAY_SEED_WARMUP_MS = CONF_RELAY_SEED_WARMUP_MS;
float RELAY_MIN_FLIP_MM = CONF_RELAY_MIN_FLIP_MM;
int   RELAY_COLLAPSE_DELAY_MS = CONF_RELAY_COLLAPSE_DELAY_MS;
int   RELAY_COLLAPSE_RAMP_MULT = CONF_RELAY_COLLAPSE_RAMP_MULT;
int   RELAY_COLLAPSE_CAP_MS = CONF_RELAY_COLLAPSE_CAP_MS;
