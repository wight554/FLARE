...
void settings_defaults(void) {
    ...
    SYNC_TENSION_RECOVERY_FLOOR_SPS = clamp_i(CONF_SYNC_TENSION_RECOVERY_FLOOR_SPS, 0, mm_per_min_to_sps(6000.0f));
    SYNC_TENSION_RECOVERY_MS = clamp_i(CONF_SYNC_TENSION_RECOVERY_MS, 0, 10000);
