...
void settings_defaults(void) {
    ...
    SYNC_TENSION_BURST_MS = clamp_i(CONF_SYNC_TENSION_BURST_MS, 0, 5000);
    SYNC_TENSION_ESC_STEP_SPS = clamp_i(CONF_SYNC_TENSION_ESC_STEP_SPS, 0, 5000);
    SYNC_TENSION_ESC_RATIO = clamp_f(CONF_SYNC_TENSION_ESC_RATIO, 1.0f, 4.0f);
