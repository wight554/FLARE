...
extern uint32_t g_loop_cur_us;
extern uint32_t g_loop_max_us;
extern uint32_t g_loop_avg_us;
extern uint32_t g_loop_overruns;
extern const char *g_loop_top_module;
