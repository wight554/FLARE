...
- `BUF_NEUTRAL` (uncertain — the buffer may drift to either rail, and only a
  click resolves it) → **creep** the floor up slowly at
  `SYNC_TENSION_PROBE_NEUTRAL`. This drives the uncertainty into a COMPRESSION
